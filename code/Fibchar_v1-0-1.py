...
"""
================================================================================
 FibChar v1.0.1  --  Fibonacci Character-Sum Research Suite
================================================================================
...
--------------------------------------------------------------------------------
    ...
    python code/Fibchar_v1-0-1.py --no-gui --N 1000000 --verify-b1

    # Five worked examples from Appendix A (~instant):
    python code/Fibchar_v1-0-1.py --self-test

    # Parallel multi-process compute (no checkpointing):
    python code/Fibchar_v1-0-1.py --no-gui --N 2000000 --verify-b1 --parallel --workers 8 --chunk-size 5000

    # Resume a previously interrupted sequential run:
    python code/Fibchar_v1-0-1.py --no-gui --N 2000000 --verify-b1 --resume
...
v1.0.1  --  2026-07-17
  * Canonical release source renamed to Fibchar_v1-0-1.py.
  * Release identity and metadata standardized for the v1.0.1 archive.
  * The existing Zenodo DOI is explicitly identified as the previous release.
  * No mathematical algorithm, computational pipeline, or output logic changed.

v1.0.1-clean vs v1.0.0
--------------------------------------------------------------------------------
...
__release_date__: str = "2026-07-17"
...
def save_json_summary(tables: dict[str, pd.DataFrame],
    ...
    summary: dict[str, Any] = {
        ...
        # The v1.0.1 Zenodo DOI is assigned only after Zenodo publication.
        "zenodo_version_doi"    : None,
        "zenodo_previous_release": "https://doi.org/10.5281/zenodo.20707467",
